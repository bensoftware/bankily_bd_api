...
public class CreateCifDaoImpl implements CreateCifDao{
	...
	public PApiCreateCifOut getCif(PApiCreateCifIn inCreateCif) {
		...
		SqlParameterSource in = new MapSqlParameterSource()
				...
				.addValue("ADT_ESTABDate", inCreateCif.adtEstabDate)
				...
				.addValue("ADTDate_CREATED", inCreateCif.adtDateCreated)
				.addValue("ADTDate_MODIFIED", inCreateCif.adtDateModified)
				...
				.addValue("ADT_ADDDate1", inCreateCif.adtAddDate1)
				.addValue("ADT_ADDDate2", inCreateCif.adtAddDate2)
				.addValue("ADT_ADDDate3", inCreateCif.adtAddDate3)
				.addValue("ADT_ADDDate4", inCreateCif.adtAddDate4)
				.addValue("ADT_ADDDate5", inCreateCif.adtAddDate5)
				.addValue("AL_ADDNumber1", inCreateCif.alAddNumber1)
				.addValue("AL_ADDNumber2", inCreateCif.alAddNumber2)
				.addValue("AL_ADDNumber3", inCreateCif.alAddNumber3)
				.addValue("AL_ADDNumber4", inCreateCif.alAddNumber4)
				.addValue("AL_ADDNumber5", inCreateCif.alAddNumber5)
				.addValue("AS_ADDString", inCreateCif.asAddString)
				.addValue("AS_ADDString2", inCreateCif.asAddString2)
				.addValue("AS_ADDString3", inCreateCif.asAddString3)
				.addValue("AS_ADDString4", inCreateCif.asAddString4)
				.addValue("AS_ADDString5", inCreateCif.asAddString5)
				.addValue("AS_ADDString6", inCreateCif.asAddString6)
				.addValue("AS_ADDString7", inCreateCif.asAddString7)
				.addValue("AS_ADDString8", inCreateCif.asAddString8)
				.addValue("AS_ADDString9", inCreateCif.asAddString9)
				.addValue("AS_ADDString10", inCreateCif.asAddString10)
				.addValue("AS_ADDString11", inCreateCif.asAddString11)
				.addValue("AS_ADDString12", inCreateCif.asAddString12)
				.addValue("AS_ADDString13", inCreateCif.asAddString13)
				.addValue("AS_ADDString14", inCreateCif.asAddString14)
				.addValue("AS_ADDString15", inCreateCif.asAddString15
						);
